...
sub create_message_html {
  ...
  $html_msg = $html_msg
            . "<th width=$header_size class=even>" . $language{$land}{"NOTITYPE"} . ":</th>\n"
            . "<td bgcolor=$NOTIFICATIONCOLOR{$o_notificationtype}>\n"
            . "$o_notificationtype</td></tr>\n"
            . "<tr><th class=odd>" . $language{$land}{"HSTATUS"} . ":</th><td>$o_hoststate</td></tr>\n"
            . "<tr><th class=even>" . $language{$land}{"HNAME"} . ":</th><td class=even>\n";
  ...
  $html_msg = $html_msg . "</td></tr>\n"
            . "<tr><th class=odd>" . $language{$land}{"HALIAS"} . ":</th><td>$o_hostalias</td></tr>\n"
            . "<tr><th class=even>" . $language{$land}{"HIP"} . ":</th><td class=even>$o_hostaddress</td></tr>\n"
            . "<tr><th class=odd>" . $language{$land}{"HGROUP"} . ":</th><td>\n";
  ...
  $html_msg = $html_msg . "</td></tr>\n"
             . "<tr><th class=even>" . $language{$land}{"ETIME"} . ":</th><td class=even>$o_datetime</td></tr>\n"
             . "<tr><th class=odd>" . $language{$land}{"HOUTPUT"} . ":</th><td>\n";
